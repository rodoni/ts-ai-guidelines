# OpenCode TypeScript Guidelines Integration

Configured for OpenCode / OpenCodeInterpreter AI agents with low-context TypeScript and Tweag agentic rules.

## Agents
- `ts-lead`: Orchestration and architectural planning.
- `ts-type-architect`: Sound type design and zero `any`.
...
- `ts-types`: Type soundness
- `ts-api`: API ergonomics
